...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "João Victor", "joao@gmail.com",
                new DateTime(1998, 4, 27), 1200.00, d1);

            Seller s2 = new Seller(2, "Victor Gomes", "victorg@gmail.com",
                new DateTime(1995, 2, 17), 1200.00, d1);

            Seller s3 = new Seller(3, "Miguel Araujo", "miguel@gmail.com",
                new DateTime(1996, 10, 10), 1200.00, d2);

            Seller s4 = new Seller(4, "Fernanda Rodrigues", "fernandinha@gmail.com",
                new DateTime(1994, 12, 19), 1290.00, d3);

            Seller s5 = new Seller(5, "Vitória Souza", "vitoria@gmail.com",
                new DateTime(1998, 5, 27), 1300.00, d3);

            Seller s6 = new Seller(6, "Bruna Gomes", "bruna@gmail.com",
                new DateTime(1999, 9, 7), 1300.00, d2);

            SalesRecord r1 = new SalesRecord(1, new DateTime(2018, 9, 25), 11000.00, SaleStatus.Billed,
                s1);
